...
;In this case, act like we started one level up 
...
;This _OFFSET is not strictly needed as it will be calculated by prepend if not here:
_OFFSET = "/training"

;The _MORE files will be parsed after this file; they can be put somewhere out of danger, ie. not under the Document Root
_MORE[] = ../offline/conf/02_training_conf.php
