...
echo "<script type='text/javascript' src='".$redirect."/scripts/set_rates.js'></script>\n";
...
<table align='center' cellpadding='4' border='2' class="list">
  ...
  <tr>
    <td id="BN_0" data-recid="0" onclick="init_row(this)" title="Click to add new rate"><img src="<?php echo $redirect?>/images/add.png"></td>
    <td id="RT_0"></td>
    <td id="EF_0"></td>
    <td id="EX_0"></td>
  </tr>
