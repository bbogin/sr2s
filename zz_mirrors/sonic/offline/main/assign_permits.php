...
case STATE::INIT:
	...
	$persons = new PERSON_SELECT(false); //false: user can't change own permits
...
case SELECTED_PROJECT:
	...
	$_STATE->msgGreet = $_STATE->project_name."<br>Assign (check) or Un-assign permissions for <br>".$_STATE->person_name;
