...
-- DROP TRIGGER `nweninger_as`.`a00_timestamp`;
-- DROP TABLE `a00_organization`;

CREATE TABLE `nweninger_as`.`a00_organization` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`a00_timestamp` BEFORE INSERT ON `nweninger_as`.`a00_organization`
FOR EACH ROW
...
-- DROP TRIGGER `nweninger_as`.`a10_timestamp`;
-- DROP TABLE `a10_project`;

CREATE TABLE `nweninger_as`.`a10_project` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`a10_timestamp` BEFORE INSERT ON `nweninger_as`.`a10_project`
FOR EACH ROW
BEGIN
  SET NEW.timestamp = UTC_TIMESTAMP();
...
-- DROP TRIGGER `nweninger_as`.`a12_timestamp`;
-- DROP TABLE `nweninger_as`.`a12_task`;

CREATE TABLE `nweninger_as`.`a12_task` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`a12_timestamp` BEFORE INSERT ON `nweninger_as`.`a12_task`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `nweninger_as`.`a14_timestamp`;
-- DROP TABLE `nweninger_as`.`a14_subtask`;

CREATE TABLE `nweninger_as`.`a14_subtask` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`a14_timestamp` BEFORE INSERT ON `nweninger_as`.`a14_subtask`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `nweninger_as`.`a20_timestamp`;
-- DROP TABLE `nweninger_as`.`a20_accounting`;

CREATE TABLE `nweninger_as`.`a20_accounting` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`a20_timestamp` BEFORE INSERT ON `nweninger_as`.`a20_accounting`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `nweninger_as`.`a21_timestamp`;
-- DROP TABLE `nweninger_as`.`a21_account`;

CREATE TABLE `nweninger_as`.`a21_account` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`a21_timestamp` BEFORE INSERT ON `nweninger_as`.`a21_account`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `nweninger_as`.`a30_timestamp`;
-- DROP TABLE `nweninger_as`.`a30_event`;

CREATE TABLE `nweninger_as`.`a30_event` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`a30_timestamp` BEFORE INSERT ON `nweninger_as`.`a30_event`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `nweninger_as`.`b00_timestamp`;
-- DROP TABLE `nweninger_as`.`b00_timelog`;

CREATE TABLE `nweninger_as`.`b00_timelog` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`b00_timestamp` BEFORE INSERT ON `nweninger_as`.`b00_timelog`
FOR EACH ROW
BEGIN
  SET NEW.timestamp = UTC_TIMESTAMP();
...
-- DROP TRIGGER `nweninger_as`.`b02_timestamp`;
-- DROP TABLE `nweninger_as`.`b02_activity`;

CREATE TABLE `nweninger_as`.`b02_activity` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`b02_timestamp` BEFORE INSERT ON `nweninger_as`.`b02_activity`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `nweninger_as`.`b10_timestamp`;
-- DROP TABLE `nweninger_as`.`b10_eventlog`;

CREATE TABLE `nweninger_as`.`b10_eventlog` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`b10_timestamp` BEFORE INSERT ON `nweninger_as`.`b10_eventlog`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `nweninger_as`.`c00_timestamp`;
-- DROP TABLE `nweninger_as`.`c00_person`;

CREATE TABLE `nweninger_as`.`c00_person` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`c00_timestamp` BEFORE INSERT ON `nweninger_as`.`c00_person`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `nweninger_as`.`c02_timestamp`;
-- DROP TABLE `nweninger_as`.`c02_rate`;

CREATE TABLE `nweninger_as`.`c02_rate` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`c02_timestamp` BEFORE INSERT ON `nweninger_as`.`c02_rate`
FOR EACH ROW
BEGIN
  SET NEW.timestamp = UTC_TIMESTAMP();
...
-- DROP TRIGGER `nweninger_as`.`c10_timestamp`;
-- DROP TABLE `nweninger_as`.`c10_person_organization`;

CREATE TABLE `nweninger_as`.`c10_person_organization` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`c10_timestamp` BEFORE INSERT ON `nweninger_as`.`c10_person_organization`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `nweninger_as`.`c20_timestamp`;
-- DROP TABLE `nweninger_as`.`c20_person_permit`;

CREATE TABLE `nweninger_as`.`c20_person_permit` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`c20_timestamp` BEFORE INSERT ON `nweninger_as`.`c20_person_permit`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `nweninger_as`.`d01_timestamp`;
-- DROP TABLE `nweninger_as`.`d01_permit`;

CREATE TABLE `nweninger_as`.`d01_permit` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`d01_timestamp` BEFORE INSERT ON `nweninger_as`.`d01_permit`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TABLE `nweninger_as`.`d02_currency`;

CREATE TABLE `nweninger_as`.`d02_currency` (
...
-- DROP TRIGGER `nweninger_as`.`d10_timestamp`;
-- DROP TABLE `nweninger_as`.`d10_preferences`;

CREATE TABLE `nweninger_as`.`d10_preferences` (
...
delimiter //
CREATE TRIGGER `nweninger_as`.`d10_timestamp` BEFORE INSERT ON `nweninger_as`.`d10_preferences`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP VIEW `nweninger_as`.`v00_timelog`;

CREATE OR REPLACE VIEW `nweninger_as`.`v00_timelog` AS 
...
-- DROP VIEW `nweninger_as`.`v10_logreport`;

CREATE OR REPLACE VIEW `nweninger_as`.`v10_logreport` AS 
...
-- DROP VIEW `nweninger_as`.`v12_taskreport`;

CREATE OR REPLACE VIEW `nweninger_as`.`v12_taskreport` AS 
