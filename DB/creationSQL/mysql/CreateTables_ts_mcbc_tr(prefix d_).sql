...
-- DROP TRIGGER `ts_mcbc_tr`.`d_a00_timestamp`;
-- DROP TABLE `d_a00_organization`;

CREATE TABLE `ts_mcbc_tr`.`d_a00_organization` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_a00_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_a00_organization`
FOR EACH ROW
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_a10_timestamp`;
-- DROP TABLE `d_a10_project`;

CREATE TABLE `ts_mcbc_tr`.`d_a10_project` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_a10_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_a10_project`
FOR EACH ROW
BEGIN
  SET NEW.timestamp = UTC_TIMESTAMP();
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_a12_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_a12_task`;

CREATE TABLE `ts_mcbc_tr`.`d_a12_task` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_a12_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_a12_task`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_a14_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_a14_subtask`;

CREATE TABLE `ts_mcbc_tr`.`d_a14_subtask` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_a14_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_a14_subtask`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_a20_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_a20_accounting`;

CREATE TABLE `ts_mcbc_tr`.`d_a20_accounting` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_a20_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_a20_accounting`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_a21_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_a21_account`;

CREATE TABLE `ts_mcbc_tr`.`d_a21_account` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_a21_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_a21_account`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_a30_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_a30_event`;

CREATE TABLE `ts_mcbc_tr`.`d_a30_event` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_a30_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_a30_event`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_b00_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_b00_timelog`;

CREATE TABLE `ts_mcbc_tr`.`d_b00_timelog` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_b00_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_b00_timelog`
FOR EACH ROW
BEGIN
  SET NEW.timestamp = UTC_TIMESTAMP();
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_b02_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_b02_activity`;

CREATE TABLE `ts_mcbc_tr`.`d_b02_activity` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_b02_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_b02_activity`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_b10_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_b10_eventlog`;

CREATE TABLE `ts_mcbc_tr`.`d_b10_eventlog` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_b10_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_b10_eventlog`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_c00_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_c00_person`;

CREATE TABLE `ts_mcbc_tr`.`d_c00_person` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_c00_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_c00_person`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_c02_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_c02_rate`;

CREATE TABLE `ts_mcbc_tr`.`d_c02_rate` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_c02_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_c02_rate`
FOR EACH ROW
BEGIN
  SET NEW.timestamp = UTC_TIMESTAMP();
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_c10_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_c10_person_organization`;

CREATE TABLE `ts_mcbc_tr`.`d_c10_person_organization` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_c10_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_c10_person_organization`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_c20_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_c20_person_permit`;

CREATE TABLE `ts_mcbc_tr`.`d_c20_person_permit` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_c20_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_c20_person_permit`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_d01_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_d01_permit`;

CREATE TABLE `ts_mcbc_tr`.`d_d01_permit` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_d01_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_d01_permit`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP TABLE `ts_mcbc_tr`.`d_d02_currency`;

CREATE TABLE `ts_mcbc_tr`.`d_d02_currency` (
...
-- DROP TRIGGER `ts_mcbc_tr`.`d_d10_timestamp`;
-- DROP TABLE `ts_mcbc_tr`.`d_d10_preferences`;

CREATE TABLE `ts_mcbc_tr`.`d_d10_preferences` (
...
delimiter //
CREATE TRIGGER `ts_mcbc_tr`.`d_d10_timestamp` BEFORE INSERT ON `ts_mcbc_tr`.`d_d10_preferences`
FOR EACH ROW
  SET NEW.timestamp = UTC_TIMESTAMP()
//
delimiter ;
...
-- DROP VIEW `ts_mcbc_tr`.`d_v00_timelog`;

CREATE OR REPLACE VIEW `ts_mcbc_tr`.`d_v00_timelog` AS 
...
-- DROP VIEW `ts_mcbc_tr`.`d_v10_logreport`;

CREATE OR REPLACE VIEW `ts_mcbc_tr`.`d_v10_logreport` AS 
...
-- DROP VIEW `ts_mcbc_tr`.`d_v12_taskreport`;

CREATE OR REPLACE VIEW `ts_mcbc_tr`.`d_v12_taskreport` AS 
